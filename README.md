...
학업 및 개인 프로젝트를 통해 **백엔드 서비스 개발, 데이터베이스 설계, 디지털 논리 설계, 클라우드 네이티브 아키텍처** 경험.

저수준 로직 설계부터 고수준 클라우드 인프라까지  
시스템 전반을 이해하고 구축하는 방향으로 학습 및 프로젝트 진행 중.  
확장성, 안정성, 유지보수성을 고려한 시스템 설계 지향.
...
Cloud / Infrastructure Engineer로 성장하는 것을 목표로 함.
